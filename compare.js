...
function renderCompareView(combinedChart, targetElement) {
  try {
    ...
    tropPreview.style.cssText = "width:100%;overflow:hidden;display:flex;";
    ...
    sc13Preview.style.cssText = "width:100%;overflow:hidden;display:flex;";
    ...
    thead.innerHTML =
      ...
      '<th style="text-align:left;padding:6px 8px;border-bottom:1px solid #ccc;">Placement</th>' +
      '<th style="text-align:left;padding:6px 8px;border-bottom:1px solid #ccc;">Tropical</th>' +
      '<th style="text-align:left;padding:6px 8px;border-bottom:1px solid #ccc;">StarChart13</th>' +
      '<th style="text-align:center;padding:6px 8px;border-bottom:1px solid #ccc;">&nbsp;</th>' +
      "</tr>";
    ...
    comparison.rows.forEach(function (row, idx) {
      ...
      tr.innerHTML =
        '<td style="padding:6px 8px;border-bottom:1px solid #eee;">' + sc13EscapeHtml(sc13DisplayName(row.body)) + "</td>" +
        '<td style="padding:6px 8px;border-bottom:1px solid #eee;">' + sc13EscapeHtml(row.tropicalSign) + " " + Math.floor(row.tropicalDegree) + "\u00B0</td>" +
        '<td style="padding:6px 8px;border-bottom:1px solid #eee;">' + sc13EscapeHtml(row.starChart13Sign) + " " + Math.floor(row.starChart13Degree) + "\u00B0</td>" +
    ...
    hThead.innerHTML =
      '<tr style="background:#f0f0f0;">' +
      '<th style="text-align:left;padding:6px 8px;border-bottom:1px solid #ccc;">Placement</th>' +
      '<th style="text-align:left;padding:6px 8px;border-bottom:1px solid #ccc;">Tropical house (1\u201312)</th>' +
      '<th style="text-align:left;padding:6px 8px;border-bottom:1px solid #ccc;">StarChart13 house (1\u201313)</th>' +
      "</tr>";
    ...
    Object.keys(tropHouses).forEach(function (name) {
      ...
      rowIdx++;
      tr.innerHTML =
        '<td style="padding:6px 8px;border-bottom:1px solid #eee;">' + sc13EscapeHtml(sc13DisplayName(name)) + "</td>" +
        '<td style="padding:6px 8px;border-bottom:1px solid #eee;">' + tropHouses[name] + "</td>" +
        '<td style="padding:6px 8px;border-bottom:1px solid #eee;">' + (sc13Entry.house != null ? sc13Entry.house : "\u2014") + "</td>";
